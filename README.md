...
| Вариант | Линия |  Исходный код: | на английском  |   на русском    |
|---------|-------|----------------|-------------|-------------------------------|
| ```1``` |```1```|| ```1``` ```function ExecuteScript(){}```       | ```1``` ```функция ВыполнитьСкрипт(){}```     |
| ```2``` |```1```|| ```1``` ```function ScriptEntryPoint(){}```    | ```1``` ```функция точкаВходаВскрипт(){}```   |
| ```3``` |```1```|| ```1``` ```function Script(){}```              | ```1``` ```функция Скрипт(){}```              |
| ```4``` |```1```|| ```1``` ```function 0(){}```                   | ```1``` ```функция 0(){}```                    |

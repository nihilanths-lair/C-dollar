...
Точка откуда начнёт выполняться код начинается с объявления главной функции, вызываемую самой VMC$. Если вы хотите встроить VMC$ в игровой движок, то для этого есть статические библиотеки компоновки, без встраивания – в виде динамической библиотеки (API).<br>
<br>

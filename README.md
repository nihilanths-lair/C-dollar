...
Однострочные комментарии (распространяется на всю строку, закрытие не требуется) –<br>
< файл: ```0.cdlr``` (исходный код на языке ```C$```)>
<br>
| код на английском | код на русском |
|-|-|
...
Однострочные комментарии (распространяется до закрытия, в пределах одной строки) –<br>
< файл: ```0.cdlr``` (исходный код на языке ```C$```)>
<br>
| код на английском | код на русском |
|-|-|
...
| код на английском | код на русском |
|-|-|
```1``` ```$ This is a multiline comment $``` | ```1``` ```$ Это многострочный комментарий $```<br>
```2``` ```$ This is a multiline comment $``` | ```2``` ```$ Это многострочный комментарий $```<br>
```3``` ```$ This is a multiline comment $``` | ```3``` ```$ Это многострочный комментарий $```<br>

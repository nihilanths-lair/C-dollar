...
-
Язык программирования С$ был придуман в целях написания скриптов под игры, в которых требуется коллосальное количество создания переменных и управления ими.

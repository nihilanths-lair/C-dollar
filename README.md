...
Точка выполнения скрипта начинается с объявления главной функции, вызываемую самой VMC$. Если вы хотите встроить VMC$ в игровой движок, то для этого есть статические библиотеки компоновки, без встраивания – в виде динамическоё библиотеки.

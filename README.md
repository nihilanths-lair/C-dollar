...
Теперь мы плавно подошли к рекурсивным вызовам функций. (по умолчанию в целях безопасности компилятор будет выдавать ошибки при их использовании, дабы не опытным кодерам не наделать глупостей)<br>
<br>
< файл: ```0.cdlr``` ><br>

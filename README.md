...
В последнем варианте создаётся функция не имеющая названия, но имеющая адрес расположения в памяти. Чтобы можно было вызвать такую функцию, вы должны получить её адрес, в момент создания.<br>
<br>

...
Однострочные комментарии (распространяется на всю строку, закрытие не требуется) –
Однострочные комментарии (распространяется до закрытия, в пределах одной строки) –
Многострочные комментарии (распространяются на несколько строк, закрытие требуется) –

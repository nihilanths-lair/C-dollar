...
C$ является встраиваемым языком, для этого есть статические библиотеки компоновки. Без встраивания – динамическая библиотека. Управление происходит через API/FFI.<br>
<br>

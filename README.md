...
<br>
В последнем варианте создаётся функция не имеющая названия. Такие функции принято называть безымянными. О том для чего они нужны и как ими пользоваться мы ещё поговорим чуть позже.

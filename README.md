...
< Тема: ```Создание и удаление локальных переменных с временем жизни```, файл: ```0.cdlr```><br>
...
< Тема: ```Использование унарного апострофа или пробела, для цифр с большим количеством разрядов```, файл: ```0.cdlr```><br>

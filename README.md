...
В языке имеется много всяких штуковин, которых нет в том же Pawn/Lua и прочих языках, которые были бы полезны при разработке проектов с большой кодовой базой.

...
|---------|---------------|------------|
| ```1``` | ```1``` ```announce function ExecuteScript(){}```       | ```1``` ```объявить функция ВыполнитьСкрипт(){}```     |
| ```2``` | ```1``` ```announce function ScriptEntryPoint(){}```    | ```1``` ```объявить функция точкаВходаВскрипт(){}```   |
| ```3``` | ```1``` ```announce function Script(){}```              | ```1``` ```объявить функция Скрипт(){}```              |
| ```4``` | ```1``` ```announce function 0(){}```                   | ```1``` ```объявить функция 0(){}```                    |
<br>

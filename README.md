...
C$ является встраиваемым языком, для этого есть статические библиотеки компоновки. Без встраивания – динамическая библиотека. Управление процессами между игровым движком и VMC$ происходит через API/FFI.<br>
<br>

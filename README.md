...
<br>
При попытке скомпилировать такой файл, получите семантическую ошибку, о том, что данная конструкция является пустой/бессмысленной (т.к. внутри неё не оказалось ни единой вложенной инструкции).

...
Точка выполнения скрипта начинается с объявления главной функции, вызываемую внешними модулями скриптов или программы (API). Три способа как можно объявить функцию, на которую будет передаваться управление потоком кода:

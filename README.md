...
О блочных скобках.<br>
В компиляторе блочные скобки используются по умолчанию, но вы при желании можете их отключить, тогда ваш код станет более привлекательным и чистым.
<br>
<br>

...
В последнем варианте создаётся функция не имеющая названия, но используемая как точка входа в скрипт. Такие функции принято называть безымянными. В одном файле допустимо создание только одной безымянной функции.<br>

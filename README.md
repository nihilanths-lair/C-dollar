...
Также можно применять многострочный комментарий в стиле /* */ . Предполагается его удаление. Был добавлен по причине его использования в Си-подобных языках.<br>
<br>
...
< Тема: ```безусловный переход в пределах конструкции``` (как у switch/case), файл: ```0.cdlr``` (исходный код на языке ```C$```)>
<br>
| код на английском | код на русском |
|-|-|

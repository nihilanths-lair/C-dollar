...
Применяется в тех случаях, когда сразу известно значение, к которому необходимо перейти. Это позволяет оптимизировать код, за счёт того, что не приходится проверять каждый вариант.

...
Рекурсивный вызов функции (по умолчанию выключен компилятором, дабы не опытным кодерам не наделать глупостей)<br>
<br>
< файл: ```0.cdlr``` ><br>
...
Если же хотите включить рекурсию, используйте инструкцию: ```recursive function call:```, со флагом: ```enabled/disable``` или ```рекурсивный вызов функций: включить/выключить```, но будьте предельно осторожны, помня о том, что необходимо создать условие для выхода из бесконечного вызова.

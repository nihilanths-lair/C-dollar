...
|---------|-------|----------------|-------------|-------------------------------|
| ```1``` |```1```|| ```1``` ```function ExecuteScript(){}```      | ```функция ВыполнитьСкрипт(){}```     |
| ```2``` |```1```|| ```1``` ```function ScriptEntryPoint(){}```   | ```функция точкаВходаВскрипт(){}```   |
| ```3``` |```1```|| ```1``` ```function Script(){}```             | ```функция Скрипт(){}```              |
| ```4``` |```1```|| ```1``` ```function 0(){}```                   | ```функция 0(){}```                    |

...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    print("|-----------------------------------------------------------------------------|");
    // Ñìåùåíèå PE-çàãîëîâêà îò íà÷àëà
    ...
    print("|        |-------------------------------------------------|                  |");
    // Ðàçìåð ñëåäóþùåãî ïîäçàãîëîâêà
    ...
    print("|        |-------------------------------------------------|                  |");
    // Âûðàâíèâàíèå â âèðò. ïàìÿòè (4 Êá.)
    ...
    print("|        |-------------------------------------------------|                  |");
    // Âûðàâíèâàíèå â exe ôàéëå (512 á.)

...
int main(int argc, char *argv[])
{
    ...
    fprint("| h=%02X | %02X %02X %02X %02X %02X %02X %02X %02X                         | %s                       |\n", offset += 2,
    ...
    fprint("| h=%02X | %02X %02X                                           | %s                       |\n", offset += 8, e_oemid[0]&255, e_oemid[1]&255, e_oemid);

    char e_oeminfo[2+1] = {0}; // Необязательный параметр
    e_oeminfo[0] = getc(file), e_oeminfo[1] = getc(file);
    fprint("| h=%02X | %02X %02X                                           | %s                       |\n", offset += 2, e_oeminfo[0]&255, e_oeminfo[1]&255, e_oeminfo);
    ...
    //print("|                                                        +-----------+            |");
    fprint("| h=%02X | %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X |                        |\n|\
      | %02X %02X %02X %02X                                     | %s                       |\n", offset += 2,
    ...
    fprint("| h=%02X | %02X %02X %02X %02X                                     | %s                      |\n", offset += 20, e_lfanew[0]&255, e_lfanew[1]&255, e_lfanew[2]&255, e_lfanew[3]&255, e_lfanew);

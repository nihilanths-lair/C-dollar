...
// Ñ÷èòàííûé áàéò-êîä ñ ôàéëà
unsigned char bytecode[0xFFFF];

/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
/*  Ýìóëÿöèÿ àðõèòåêòóðû ïðîöåññîðà x86 (16 bits)  */
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
// Ðåãèñòðû âèðòóàëüíîé ìàøèíû
typedef struct {
  uint16_t ax;
  uint16_t bx;
  uint16_t cx;
...
// Ïðîòîòèïû ôóíêöèé äëÿ òàáëèöû îïêîäîâ
...
// Ìàññèâ óêàçàòåëåé íà ôóíêöèè
void (*opcode_table[0xFF])(RegistersCPUx86 *registers) = {0};

// Ðåàëèçàöèÿ ôóíêöèé, âûïîëíÿþùèå êîìàíäû
void mnc__mov_al(RegistersCPUx86 *registers) 
{
    registers->ip++;
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
/*  Ñâîé ñîáñòâåííûé íàáîð êîìàíä è ðåãèñòðîâ âèðòóàëüíîé ìàøèíû  */
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
// -- Â ðàçðàáîòêå -- //
// Ðåãèñòðû âèðòóàëüíîé ìàøèíû
typedef struct {
...
{
    setlocale(0, "");
    // Èíèöèàëèçàöèÿ óêàçàòåëåé íà ôóíêöèè
    ...
    // Èíèöèàëèçàöèÿ ðåãèñòðîâ è óñòàíîâêà ïåðâîíà÷àëüíûõ çíà÷åíèé
    ...
    printf("\nÊîë-âî áàéò â ôàéëå: %lld.\n", fsize);
	fclose(h);

    // èíôîðìàöèÿ äëÿ îòëàäêè êîäà
    //printf("\n- 16-bits registers -\n");

    // Âûïîëíåíèå êîäà âèðòóàëüíîé ìàøèíû

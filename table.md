...
## 🧩 2.1. Двухбайтовые инструкции: **MOV r8, imm8** (176–183 / B0–B7) — 2-байтовые, с immediate

Инструкции длиной 2 байта:  
- `MOV r8, imm8`  
- Формат: `B0–B7` + 1 байт (00–FF)
...
## 🧩 2.2. Трёхбайтовые инструкции: MOV r16, imm16 (184–191|B8–BF) — 3-байтовые, с immediate
